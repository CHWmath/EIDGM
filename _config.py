...
def get_prms(name, dist_type=[], p_range=[], modes=[]):
    if name == 'exp':
        ...
        prms_GAN = {'num_bins':5, 'plow':0.97, 'phigh':1.03, 'num_noised':12, 'modes':modes, 'num_gen_ratio':1, 'num_gen_plot':1000, 'data_noise_scale':0.0, 'init_noise_scale_wgan':0.0, 'num_cut':0, 'noise_dim':16, 'width':64, 'depth':4,'lr_G':1e-4, 'lr_D':1e-4, 'ratio_G':1, 'num_gen_traj':-1, 'center_penalty':False}
    ...
    if name == 'lorenz':
        ...
        prms_GAN = {'num_bins':9, 'plow':0.99, 'phigh':1.01, 'num_noised':12, 'modes':modes, 'num_gen_ratio':3, 'num_gen_plot':500, 'data_noise_scale':0.0, 'init_noise_scale_wgan':0.0, 'num_cut':0, 'noise_dim':32, 'width':128, 'depth':4,'lr_G':1e-4, 'lr_D':1e-4, 'ratio_G':1, 'num_gen_traj':-1, 'center_penalty':False}
